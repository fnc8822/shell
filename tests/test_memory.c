...
void test_efficiency(int method) {
  ...
  double fragmentation =
      ((double)total_allocated - (double)cumulative_allocation) /
      (double)total_allocated * 100;
...
void test_efficiency_best_fit() { test_efficiency(BEST_FIT); }
void test_efficiency_first_fit() { test_efficiency(FIRST_FIT); }
void test_efficiency_worst_fit() { test_efficiency(WORST_FIT); }
